...
# ALL_TRS=("C" "D") # repeat the experiment for different source domains. For the full set of experiments, use A B C D E F
# ALL_TRS=("E" "F") # repeat the experiment for different source domains. For the full set of experiments, use A B C D E F
NCLASS=2
...
# save
SAVE_EPOCH=500
SAVE_DIR="/root/autodl-tmp/output/prostate/IDsAE"
...
# continue train
CONTINUE_TRAIN=True
RELOAD_MODEL_DIR="/root/autodl-tmp/output/prostate/IDsAE/*/ENC/net_1000.pth"
